...
const BACKEND_URL = "https://grindhub-api.notaroomba.dev"
...
async function getMissions() {
  //get mission
  let last = await superagent.post(BACKEND_URL + "/missions").send([{ time: { $gt: 0 } }, { sort: { time: -1 }, }])
  if ((last.body.length == 0 && last.text === "[]") || (last.body[0].time >= (Date.now() - 86400))) {
